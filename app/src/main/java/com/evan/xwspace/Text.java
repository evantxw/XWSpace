...
//        msp.setSpan(new ScaleXSpan(2.0f), 49, 51, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE); //2.0f表示默认字体宽度的两倍，即X轴方向放大为默认字体的两倍，而高度不变
        msp.setSpan(new ClickableSpan() {
            ...
            public void onClick(View widget) {
                Toast.makeText(Text.this, "click success", Toast.LENGTH_SHORT).show();
            }
...
/*
        XmlResourceParser xppcolor = getResources().getXml(android.R.color.holo_blue_light);
        ...
        /*XmlResourceParser xpplinkcolor = getResources().getXml(android.R.color.background_light);
        ...
        Drawable drawable = getResources().getDrawable(R.drawable.banner_dian_blur);
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.evan.xwspace/http/host/path")
        );
